...
const products = [
  ...
  { name: "Farm Fresh Egg (Dim)", cats: "breakfast", img: "https://images.unsplash.com/photo-1525351484163-7529414344d8?auto=format&fit=crop&q=80&w=400", fallback: "", variants: [{ label:"Omelette (৳30)", val:30 },{ label:"Fried/Poached (৳30)", val:30 }] },
  { name: "Beef Bhuna Khichuri", cats: "breakfast lunch", img: "e338491b-063e-4228-ac0e-3ca9c73536a8.png", fallback: "https://images.unsplash.com/photo-1544025162-8111142154ea?w=400", variants: [{ label:"Full Plate (৳280)", val:280 },{ label:"Half Plate (৳160)", val:160 }], badge: "Heavy Breakfast" },
  { name: "Premium Mutton Kacchi", cats: "lunch dinner", img: "images (14).jpg", fallback: "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400", variants: [{ label:"Full Plate (৳450)", val:450 },{ label:"Half Plate (৳250)", val:250 }], badge: "Bestseller" },
  { name: "Chittagong Kala Bhuna", cats: "lunch dinner", img: "4a1cb3da-4300-4954-b526-8ac5f40146f1.png", fallback: "https://images.unsplash.com/photo-1544025162-8111142154ea?w=400", variants: [{ label:"Full Plate (৳350)", val:350 },{ label:"Half Plate (৳190)", val:190 }], badge: "Popular" },
  { name: "Old Dhaka Beef Tehari", cats: "lunch dinner", img: "https://images.unsplash.com/photo-1633945274405-b6c8069047b0?w=400", fallback: "", variants: [{ label:"Full Plate (৳220)", val:220 },{ label:"Half Plate (৳120)", val:120 }] },
  { name: "Premium Golap Jam", cats: "desserts", img: "0ddd6c12-16ec-45c4-b487-b80951e661d3.png", fallback: "https://images.unsplash.com/photo-1589115795325-1eec578961fb?w=400", variants: [{ label:"250gm (৳150)", val:150 },{ label:"500gm (৳300)", val:300 },{ label:"1kg (৳420)", val:420 }], badge: "Must Try" },
  { name: "Traditional Kalo Jam", cats: "desserts", img: "5c9a67e3-cf74-4c1d-8284-d8286d70bffe.png", fallback: "https://images.unsplash.com/photo-1589115795325-1eec578961fb?w=400", variants: [{ label:"250gm (৳160)", val:160 },{ label:"500gm (৳320)", val:320 },{ label:"1kg (৳420)", val:420 }] },
  { name: "Spongy Roshogolla", cats: "desserts", img: "32592ad6-fe80-41e8-a7a3-872e94c0bc1c.png", fallback: "", variants: [{ label:"250gm (৳140)", val:140 },{ label:"500gm (৳280)", val:280 },{ label:"1kg (৳280)", val:280 }] },
  { name: "Premium Sondesh", cats: "desserts", img: "74221d1f-efce-452f-8731-e368a05f2e5b.png", fallback: "", variants: [{ label:"4pcs (৳180)", val:180 },{ label:"8pcs (৳360)", val:360 }] },
  { name: "Dark Chocolate Cake", cats: "desserts", img: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=400", fallback: "", variants: [{ label:"1 Slice (৳150)", val:150 },{ label:"1 Pound (৳800)", val:800 }] },
  { name: "Premium Sponge Cake", cats: "desserts", img: "0f144ebe-252c-474d-b4fd-5b2fb102b76b.png", fallback: "https://images.unsplash.com/photo-1557308536-ee471ef2c390?w=400", variants: [{ label:"1 Slice (৳120)", val:120 },{ label:"1 Pound (৳650)", val:650 }] },
  { name: "Vanilla Bean Cake", cats: "desserts", img: "efbacffe-7036-4fd0-beb4-43eafe0c7e00.png", fallback: "https://images.unsplash.com/photo-1557308536-ee471ef2c390?w=400", variants: [{ label:"1 Slice (৳130)", val:130 },{ label:"1 Pound (৳700)", val:700 }] },
  { name: "Premium Hot Soup", cats: "lunch dinner", img: "https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400", fallback: "", variants: [{ label:"Thai Clear (৳150)", val:150 },{ label:"Chicken Corn (৳130)", val:130 }], badge: "Appetizer" },
  { name: "Soft Tandoori Naan", cats: "lunch dinner", img: "https://images.unsplash.com/photo-1505253758473-96b7015fcd40?w=400", fallback: "", variants: [{ label:"Butter Naan (৳40)", val:40 },{ label:"Garlic Naan (৳60)", val:60 }] },
  { name: "Authentic Tom Yum Goong", cats: "lunch dinner", img: "download (15).jpg", fallback: "https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400", variants: [{ label:"Regular (৳350)", val:350 },{ label:"Family (৳600)", val:600 }], badge: "Hot & Spicy" },
  { name: "Classic Pad Thai Noodles", cats: "lunch dinner", img: "https://images.unsplash.com/photo-1559314809-0d155014e29e?w=400", fallback: "", variants: [{ label:"Chicken (৳250)", val:250 },{ label:"Prawn (৳300)", val:300 }], badge: "Must Try" },
  { name: "Thai Basil Chicken", cats: "lunch dinner", img: "https://images.unsplash.com/photo-1564834724105-918b73d1b9e0?w=400", fallback: "", variants: [{ label:"1 Plate (৳280)", val:280 }] },
  { name: "Special Thai Fried Rice", cats: "lunch dinner", img: "https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=400", fallback: "", variants: [{ label:"Chicken (৳220)", val:220 },{ label:"Mixed (৳260)", val:260 }], badge: "Crowd Favorite" },
  { name: "Traditional Borhani", cats: "drinks lunch dinner", img: "images (11).jpg", fallback: "https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=400", variants: [{ label:"1 Glass (৳80)", val:80 },{ label:"1 Liter (৳300)", val:300 }], badge: "Digestive" },
  { name: "Coca-Cola", cats: "drinks lunch dinner", img: "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=400", fallback: "", variants: [{ label:"250ml (৳20)", val:20 },{ label:"500ml (৳50)", val:50 },{ label:"1L (৳75)", val:75 },{ label:"1.5L (৳95)", val:95 },{ label:"2L (৳110)", val:110 }] },
  { name: "Refreshing 7 Up", cats: "drinks lunch dinner", img: "7up.jpg", fallback: "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=400", variants: [{ label:"250ml (৳20)", val:20 },{ label:"500ml (৳50)", val:50 }] },
  { name: "Mojo", cats: "drinks lunch dinner", img: "mojo.jpg", fallback: "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=400", variants: [{ label:"250ml (৳20)", val:20 },{ label:"500ml (৳50)", val:50 }] }
];
...
function renderMenu() {
  ...
  products.forEach(p => {
    ...
    const fallbackAttr = p.fallback ? `onerror="this.src='${p.fallback}'"` : '';
    container.innerHTML += `
      <div class="product-item-card ${catsClass}">
        ${badgeHtml}
        <img src="${imgSrc}" alt="${p.name}" ${fallbackAttr}>
